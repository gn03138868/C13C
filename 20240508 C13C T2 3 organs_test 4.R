...
k1B <- 0.46786613
C2B <- 0.024940457
#C1C <- 1.001632481 here we did not sample after 13C pulse labelling due to concern treatment effect of digging a hole in the culm until D14
#k1C <- 0.415758923
C2C <- 0.000967317


Total13C = 10.33071177 + 2.928492099
}
...
write.csv(df, file = "theoretical_valuesfittoexperimentsT2_R_4.csv", row.names = FALSE)
}
...
ggsave("C:/Users/Sorbus/Downloads/work log on task 2/T2_3organs_plot_R4.jpg", p, dpi = 600, width = 10, height = 6)
}
