### Step 1. Input experimental data
{
  ...
  k1B <- 0.387716815
  C2B <- 0.03316654
  #C1C <- 1.001632481 here we did not sample after 13C pulse labelling on Day 0 due to concern treatment effect of digging a hole in the culm until D14
  #k1C <- 0.334551917
  C2C <- 0.001694612
...
write.csv(df, file = "theoretical_valuesfittoexperimentsT1_R_4.csv", row.names = FALSE)
}
...
ggsave("C:/Users/Sorbus/Downloads/work log on task 2/T1_3organs_plot_R4.jpg", p, dpi = 600, width = 10, height = 6)
}
