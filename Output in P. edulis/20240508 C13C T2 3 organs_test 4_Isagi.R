...
write.csv(df, file = "theoretical_valuesfittoexperimentsT2_R_4_Isagi.csv", row.names = FALSE)
}
...
ggsave("C:/Users/Sorbus/Downloads/work log on task 2/T2_3organs_plot_R4_Isagi.jpg", p, dpi = 600, width = 10, height = 6)
}
