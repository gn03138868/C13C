...
Total13C = 8.133904955 + 2.79385781
}
...
write.csv(df, file = "theoretical_valuesfittoexperimentsT2_R_4_Wang.csv", row.names = FALSE)
}
...
ggsave("C:/Users/Sorbus/Downloads/work log on task 2/T2_3organs_plot_R4_Wang.jpg", p, dpi = 600, width = 10, height = 6)
}
