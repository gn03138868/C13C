### Step 1. Input experimental data
{
  ...
  Total13C <- 5.49541624 + 1.318766162
}
...
write.csv(df, file = "theoretical_valuesfittoexperimentsT1_R_4_Abe.csv", row.names = FALSE)
}
...
ggsave("C:/Users/Sorbus/Downloads/work log on task 2/T1_3organs_plot_R4_Abe.jpg", p, dpi = 600, width = 10, height = 6)
}
